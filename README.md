# PokerChipCalc
## Website for calculating the number of chips per player, given number of chips and denomination

### How to use
- Go to chip setup page
- Specify, number of chips per denomination available and save the chip set up
